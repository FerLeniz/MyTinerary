    ...
    return(
        <footer className="row text-center">
            ...
            <ul className="list-unstyled">
                ...
                <li>
                    <a href="https://www.facebook.com/mytineraryonline/" target='_blank' rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-facebook footerIcon"
                        viewBox="0 0 16 16">
                        <path
            ...
            <h5 className="text-white">Copyright © All rights Reserved</h5>
            </div>
